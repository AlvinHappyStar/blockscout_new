...
import steamxIcon from 'icons/social/steamxlogo.svg';
...
const Footer = () => {
  ...
  const BLOCSKOUT_LINKS = [
   ...
   
    {
      ...
      iconSize: '18px',
      text: 'Twitter',
      url: 'https://www.twitter.com/steam_exchange',
    },
    {
      icon: discordIcon,
      iconSize: '18px',
      text: 'Discord',
      url: 'https://discord.gg/AcdceuZt2c',
    },
    {
      icon: mediumIcon,
      iconSize: '18px',
      text: 'Medium',
      url: 'https://medium.com/@SteamExchange',
    },
  ...
  return (
    <Flex direction={{ base: 'column', lg: 'row' }} p={{ base: 4, lg: 9 }} borderTop="1px solid" borderColor="divider">
      <Box flexGrow="1" mb={{ base: 8, lg: 0 }}>
        ...
        <Link fontSize="xs" href="https://steamexchange.io" target="_blank">steamexchange.io</Link>
          <Text mt={ 3 } mr={{ base: 0, lg: '114px' }} maxW={{ base: 'unset', lg: '470px' }} fontSize="xs">
          Learning, innovation, and scalable digital asset solutions.
        </Text>
        </Box>
        <Text mt={ 3 } mr={{ base: 0, lg: '114px' }} maxW={{ base: 'unset', lg: '470px' }} fontSize="xs">
        Explore Rails Network with Steam Exchange, powered by <Link fontSize="xs" href="https://www.blockscout.com/" target="_blank">Blockscout</Link>. Unleash the potential of advanced block exploration and analysis.
        </Text>
